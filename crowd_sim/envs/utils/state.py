...
class JointState(object):
    def __init__(self, robot_state, human_states, imitation_learning):
...
def tensor_to_joint_state(state):
    ...
    human_states = [ObservableState_nov(human_state[0], human_state[1], human_state[2]) for human_state in human_states]
    return JointState(robot_state, human_states, False)
